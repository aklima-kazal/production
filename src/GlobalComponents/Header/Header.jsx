      ...
      <Container>
        <div className="flex justify-center items-center w-full  md:pt-[40px]">
          <div
            ...
            role="button"
            className="items-center justify-center absolute right-0 top-[100px] px-10 sm:block md:hidden"
          >
            <RiMenuSearchFill className="text-2xl  cursor-pointer w-10 h-10 text-white" />
          </div>
