      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-x-[50px] ">
          ...
          <div className="mt-[30px] lg:mt-0 text-center lg:text-left ">
            ...
            <h4 className="font-bold text-[60px] md:text-[72px] text-[#FFFFFF] font-roboto mb-[30px] leading-[72px]">
              Make it Visually Appealing
            </h4>
            <span className="text-[#82869A] font-bold font-roboto text-[20px] sm:text-[24px] mb-[30px] mt-[30px]">
