    ...
    <>
      <div className="w-full mt-[-150px] text-center p-20  bg-radial-[at_10%_25%] from-rose-950 to-slate-900 to-75%">
        <Container>
          {isDesktopOrLaptop ? (
            <motion.div
              animate={{ translateX: [70, 20, 10] }}
              className="mt-[100px]"
            >
              <h4 className="text-[#FF5E3A]  font-bold font-roboto text-[14px]">
                ------ABOUT
              </h4>
            ...
            <div className="mt-[100px]">
              ...
              <div className="mb-[40px]">
                <h5 className="font-bold text-7xl md:text-8xl font-roboto mt-2.5 mb-5 text-[#FFFFFF] capitalize">
                  {window.location.pathname.split("/")[1]}
                </h5>
                <div className="flex gap-x-2 items-center justify-center">
                  <div>
