...
const Banner = () => {
  return (
    <div className=" mt-[-180px] p-12 lg:p-40  bg-radial-[at_10%_25%] from-rose-950 to-slate-900 to-75%">
      <Container>
        <div className="mt-[280px] lg:mt-[170px]">
          <motion.div animate={{ x: [70, 20, 10] }}>
            ...
            <h2 className="font-bold text-6xl lg:text-8xl font-roboto mt-2.5 mb-8 text-[#FFFFFF]  md:w-[71%] lg:w-[118%] xl:w-[90%] xxl:w-[70%]">
              Behind Every Great Film is a Visionary.
            </h2>
            <h4 className="font-normal font-inter text-xl text-[#ffffff] w-[68%] ">
